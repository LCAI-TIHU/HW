...
// History : 2021-Sep-21 11:08:18 AM - Created
//
//---------------------------------------------------------------------------
...
// internal wires
(*mark_debug = "TRUE"*)    wire PCIE_EP_LNK_UP;
wire        TDO;
wire        TDI;
wire        TMS;
wire        TCK;
...
(*mark_debug = "TRUE"*)    wire u_uncore_top_riscv_rst_s;
wire        u_uncore_top_riscv_debug_clk_s;
(*mark_debug = "TRUE"*)    wire u_uncore_top_riscv_debug_rst_s;
wire        u_uncore_top_riscv_rtc_toggle_s;
wire        u_uncore_top_per_clk_s;
(*mark_debug = "TRUE"*)    wire u_uncore_top_core_nic_rst_n_s;
wire        u_uncore_top_dla_csb_clk_s;
wire        u_uncore_top_dla_core_clk_s;
(*mark_debug = "TRUE"*)    wire u_uncore_top_mac_rst_n_s;
wire        u_uncore_top_dma_clk_s;
(*mark_debug = "TRUE"*)    wire u_uncore_top_dma_rst_n_s;
wire        por_rstn_sync_s;
wire        u_xdma_0_top_axi_aclk_s;
(*mark_debug = "TRUE"*)    wire u_xdma_0_top_axi_aresetn_s;
(*mark_debug = "TRUE"*)    wire u_uncore_top_ddr_rst_s;
(*mark_debug = "TRUE"*)    wire u_ddr4_0_top_c0_init_calib_complete_s;
wire        msi_enable_s;
wire        msix_enable_s;
wire [2:0]  msi_vector_width_s;
(*mark_debug = "TRUE"*)    wire [2:0] usr_irq_req_s;
(*mark_debug = "TRUE"*)    wire [2:0] usr_irq_ack_s;
...
//    .u_uncore_top_jtag2ahb_tdo_i(u_uncore_top_jtag2ahb_tdo_s),
//    .u_soc_top_TDI_i(TDI),
//    .u_soc_top_TMS_i(TMS),
//    //output ports
//    .u_tdo_mux_z_o(TDO),
...
vio_0 vio_0_inst (
.clk(u_uncore_top_riscv_clk_s),
.probe_out0(BOOT_STRAP),
.probe_out1(user_rst)
);
...
uncore_top u_uncore_top(
    .sys_clk_i(SYS_CLK_REF),
    .sys_rst_n_i(PCIE_EP_nPRESET),
