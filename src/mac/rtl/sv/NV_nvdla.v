...
output                   mac_a2accu_pvld;
output [32/2-1:0]        mac_a2accu_mask;
output [22 -1:0]         mac_a2accu_data0;
...
output                   mac_b2accu_pvld;
output [32/2-1:0]        mac_b2accu_mask;
output [22 -1:0]         mac_b2accu_data0;

output                   cacc2sdp_valid;
output                   cacc2sdp_ready;
output [16*32+2-1:0]     cacc2sdp_pd;

output                   cacc2sdp_adpt_valid;
output                   cacc2sdp_adpt_ready;
output [16*32 +1:0]      cacc2sdp_adpt_pd;
